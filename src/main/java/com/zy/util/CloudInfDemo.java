...
import com.zy.handler.ImageValidate;
...
//		rechargeFlow();
	...
	/**
	 * 发生短信验证码
	 * {"result":0,"msg":"成功","trade_id":"20200428102942560390","success_count":1,"pay_count":1,"black_words":null,"error_mobiles":"","black_mobiles":""}
	 */
	public static String sendSmsCode(String telephone,String code) {
		log.info("telephone + code:  " + telephone +"  +  "+code);
