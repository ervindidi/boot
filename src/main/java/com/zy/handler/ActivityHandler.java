...
public class ActivityHandler {
    ...
    public HashMap<String,Object> lottery(String token){
        ...
        UserInfo userInfo = userService.findById(user_id).get();
        ...
        lotteryDetailService.add(lotteryDetail);
        integralDetailService.add(integralDetail);
        goldDetailService.add(goldDetail);
